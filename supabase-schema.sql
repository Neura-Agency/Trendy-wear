...
create table if not exists public.orders (
  ...
  refund_type text check (refund_type in ('quantity', 'amount', 'replacement') or refund_type is null),
  ...
  original_item_returned boolean,
  refund_reason text,
  refund_size_quantities jsonb,
  refund_color_quantities jsonb,
  refund_variant_quantities jsonb,
